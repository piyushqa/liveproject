...
import pages.PageImportEncounter;
...
public class TestImportEncounter {
...
//	}
	...
	@Test(description = "This test perform encounter on Existin glass and import", priority = 2, enabled = true, dependsOnMethods="testLogin",dataProvider = "ModifyEncounterDetails", dataProviderClass = TestDataProviders.class)
	public void encounterOnExistingGlass(String fName, String lName, String provider, String category,
		...
		PageImportEncounter importEncounter = new PageImportEncounter(driver, wait, action);
