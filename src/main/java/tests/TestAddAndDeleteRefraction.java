...
//http://128.136.92.176/testlink/linkto.php?tprojectPrefix=INTE&item=testcase&id=INTE-8
//http://128.136.92.176/testlink/linkto.php?tprojectPrefix=INTE&item=testcase&id=INTE-10
...
import pages.PageAddAndDeleteRefraction;
...
public class TestAddAndDeleteRefraction {
	...
	@Parameters({ "Enviorment", "FirstName", "LastName", "Provider", "OD", "OdSphere", "OdCyliender", "OdAxis", "OdAdd",
			...
			"NoCharges" })
	@Test(description = "In this test case we add and delete the refraction from vision tab", priority = 2, enabled = true, dataProvider = "AddAndDeleteRefractionDetails", dataProviderClass = TestDataProviders.class)
	public void checkAddAndDeleteRefraction(String enviorment, String fName, String lName, String provider, String od,
			String odSphere, String odCyliender, String odAxis, String odAdd, String os, String osSphere,
		...
		PageAddAndDeleteRefraction adddAndDelRef = new PageAddAndDeleteRefraction(driver, wait, builder);
		adddAndDelRef.verfiyAddAndDeleteRefraction(provider, od, odSphere, odCyliender, odAxis, odAdd, os, osSphere,
