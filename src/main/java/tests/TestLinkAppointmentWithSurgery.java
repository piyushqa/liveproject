...
import pages.PageLinkAppointmentWithSurgery;
import utilities.ScreenShot;
import utilities.SetUp;
import utilities.TestDataProviders;

public class TestLinkAppointmentWithSurgery {
	...
	@Parameters({ "Enviorments", "MRN", "VisitType", "Date", "Appointment", "FirstName", "LastName",
			...
			"IOLCalCulationFormula", "PlannedIOL", "Documents" })
	@Test(description = "In this secnario we check ASC integration", priority = 1, enabled = true, dataProvider = "LinkAppointmentWithSurgeryDetails", dataProviderClass = TestDataProviders.class)
	public void checkTestLinkAppointmentWithSurgery(String enviorment, String mrn, String visitType, String date,
			String appointment, String fName, String lName, String favCategories, String scheduleSurgery,
			...
			String repeatSurgeryBySameSurgeon, String repeatSurgeryByDiffSurgeon, String locationOfSurgery, String when,
		...
		new PageLinkAppointmentWithSurgery(driver, builder, wait).verifyLinkAppointmentWithSurgery(mrn, visitType, date,
				appointment, fName, lName, favCategories, scheduleSurgery, whichEye, associateProWithProblem,
				categoryOfSurgery, Boolean.parseBoolean(comanaging), Boolean.parseBoolean(stagedProcedure),
