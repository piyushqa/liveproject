...
public class PatientModifyTest {
...
//	}
	...
	@Test(description = "Test to modify a Patient", priority = 4, enabled = true, dataProvider = "patientDetails", dataProviderClass = TestDataProviders.class)
	public void tstModifyPatient(
			String mrn,
			  String pmsid,
			  String firstName,
			  String lastName,
		...
		lclPgPatientSearch.searchPatient("", "", mrn, true);
		lclpgCreatePatient = lclPgLanding.modifyPatient();
		lclpgCreatePatient.modifyPatient(
				mrn,
				  pmsid,
				  firstName,
				  lastName,
